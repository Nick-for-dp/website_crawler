...
class GMRBNewsCrawler:
    def __init__(self) -> None:
        ...
        self.url = r'https://epaper.gmw.cn/gmrb/html/'
    ...
    def find_gmrb_paper_link(self) -> Optional[str]:
        ...
        url = f"{self.url}{year_month}/{day}/nbs.D110000gmrb_01.htm"
        return url
    ...
    def get_news_dict(self):
        ...
        # 获取包含日报跳转链接的ul标签
        div_tag = soup.find('div', id='titleList')
        ul_tag = div_tag.find('ul') # type: ignore
    ...
    def get_news(self):
        try:
            ...
            for title, url in news_dict.items():
                ...
                content_div_tag = child_soup.find('div', id="articleContent")
